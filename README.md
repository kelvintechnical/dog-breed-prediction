...
<!-- TODO: Add your actual metrics below after extracting from Colab -->
<!-- | Validation Accuracy | XX.X% | -->
<!-- | Test Accuracy | XX.X% | -->
<!-- TODO: Embed training curves and confusion matrix screenshots -->
<!-- ![Training Curves](assets/training_curves.png) -->
<!-- ![Confusion Matrix](assets/confusion_matrix.png) -->
> **Tip for Kel:** Export your training history plots and confusion matrix from Colab, save them in an `assets/` folder, and uncomment the lines above. Metrics + visuals are the single biggest credibility signal in ML repos.
---
Demo
...
└── README.md
```
> **Note:** `dog_breed_model.keras` is excluded via `.gitignore` due to file size.
...
Preprocessing matters as much as architecture. Normalizing pixel values to [0.0–1.0] and resizing to a consistent 224×224 had a measurable impact on convergence speed.
